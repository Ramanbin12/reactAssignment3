...
const Componentbanner = () => {
  return (
     ...
     <div className='hidden md:flex w-[700px] flex flex-col  bg-[#7296AB] text-center md:p-5 lg:p-12 space-y-4 rounded-lg absolute md:-top-[10%] lg:-top-[20%] left-1/2 transform -translate-x-1/2'> 
